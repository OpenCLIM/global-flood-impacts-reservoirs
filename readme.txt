cmd in folder C:\Users\steve\Documents\CityCAT-dafni\global-flood-impacts-reservoirs
start docker desktop
docker build -t reservoirs .
Run container in Docker Desktop. In Images find friction-coeffs. Click on the play button. Then "optional settings" and call "Container name" something like "global-flood-impact-reservoirs"
or docker run --name global-flood-impact-reservoirs reservoirs 

docker cp global-flood-impact-reservoirs:/data/outputs/reservoirs/longbenton.gpkg ./longbenton.gpkg

docker save -o reservoirs.tar reservoirs
compress reservoirs.tar to reservoirs.tar.gz using 7Zip add to archive
